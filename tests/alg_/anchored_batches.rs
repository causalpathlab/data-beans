...
use data_beans::alg::collapse_data::{collapse_columns_multilevel_with_hierarchy, MultilevelParams};
...
fn run(tag: &str, anchored: bool) -> data_beans::alg::collapse_data::CollapsedOut {
...
fn mean_abs_log_delta(out: &data_beans::alg::collapse_data::CollapsedOut, b: usize) -> f32 {
