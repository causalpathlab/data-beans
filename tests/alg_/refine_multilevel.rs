//! Integration tests for `data_beans::alg::refine_multilevel::refine_assignments`.
//!
...
use data_beans::alg::collapse_data::PbSampleLayout;
use data_beans::alg::refine_multilevel::{
