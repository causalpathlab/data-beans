...
//!
//! Where [`crate::alg::feature_coarsening::compute_feature_coarsening`] runs a single
...
//! moves, mirroring the cell-side [`crate::alg::refine_multilevel`].
//!
//! ## Two phases
//!
...
//!    [`crate::alg::dc_poisson::refine_with_proposer`] for the Gibbs+greedy sweeps.
...
//! - The "feature axis" inside [`crate::alg::dc_poisson::Profiles`] is the *sample*
//!   axis here (each entity is a feature; its profile is a row of `sketch_ds`).
//!   [`crate::alg::dc_poisson::FeatureWeighting`] therefore weights *samples*; default
...
use crate::alg::feature_coarsening::{compute_feature_coarsening, FeatureCoarsening};
